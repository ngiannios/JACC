...
from utility.hash_util import HashUtil #hash_string_256, hash_block
...
class Verification:
    ...
    @staticmethod
    def valid_proof(transactions, last_hash, proof, guess_hass_proof_sting):
        ...
        return guess_hash[0:2] == guess_hass_proof_sting
        
    @classmethod
    def verify_chain(cls, blockchain, guess_hass_proof_sting):
        ...
        for (index, block) in enumerate(blockchain):
            ...
            if block.previous_hash != HashUtil.hash_block(blockchain[index - 1]):
                return False
            if not cls.valid_proof(block.transactions[:-1], block.previous_hash, block.proof, guess_hass_proof_sting):
